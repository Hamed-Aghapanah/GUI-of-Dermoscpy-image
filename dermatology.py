...
#            self.ui.classification_box.setText('classification')
            ...
            self.ui.Author.setText('Created by Alireza Zahedi    Tarbiat Moderes University     Version 2 , 2023') 
...
#            self.ui.classification_box.setText('classification')
            ...
            self.ui.Author.setText('Créé par Alireza Zahedi Université des sciences médicales d Ispahan Version 1 , 2023') 
...
#            self.ui.classification_box.setText('classification')
            ...
            self.ui.Author.setText('Gemaakt door Alireza Zahedi Tarbiat Modares University versie 1, 2023') 
...
#            self.ui.classification_box.setText('classification')
            ...
            self.ui.Author.setText('由Alireza Zahedi伊斯法罕医科大学 第1版创建，2023年') 
...
#            self.ui.classification_box.setText('classification')
            ...
            self.ui.Author.setText('Creado por Alireza Zahedi Isfahan Universidad de Ciencias Médicas Versión 1, 2023') 
            self.ui.pushButtonColor1.setText('Background') 
            self.ui.author_7.setText('    Color') 
...
#            self.ui.classification_box.setText('classification')
            ...
            self.ui.Author.setText('Dicipta oleh Alireza Zahedi Isfahan Universiti Sains Perubatan Versi 1, 2023') 
...
#            self.ui.classification_box.setText('classification')
            ...
            self.ui.Author.setText('Creato da Alireza Zahedi Tarbiat Modares University Versione 1, 2023') 
...
#            self.ui.clinical_box.setText('clinical')
            self.ui.asymetric.setText('عدم تقارن')
...
#        cv2.imshow('image1',image1)
        ...
        try:
            ...
            import random
            features=[random.randint(1, 99) /100 ,
                      random.randint(3, 99) /100,
                      random.randint(1, 99) /100,
                      random.randint(2, 99) /100]
            img = image01
            cnt1=4
